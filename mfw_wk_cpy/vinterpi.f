...
c     Copyright violation by Mahendra Bhagwat

      subroutine vinterpi(nr,np,nw,pw,nz,pif,zif,vx,vy,vz,Pin,Zin)
...
c
     ...
     &        zint,r,p,w,z,p1,z1,p2,z2,p3
c
      DOUBLE PRECISION vx(rdim,adim,wdim,zdim),
     &       vy(rdim,adim,wdim,zdim),
     &       vz(rdim,adim,wdim,zdim)
c
c-mb interpolation between Pin and Pin-pif
c-mb or interpolation between Zin and Zin-zif
      INTEGER Pin,Zin
c
c ----------------------------------------------------------------------
c
...
c//      do z=1,nz-zif,zif
      ...
      z=Zin-zif
      zf=1
      do zint=z+1,z+zif-1,1

         vx(r,p,w,zint)=vx(r,p,w,z)-
     &   DBLE(zf)*(vx(r,p,w,z)-vx(r,p,w,z+zif))/DBLE(zif)
         vy(r,p,w,zint)=vy(r,p,w,z)-
     &   DBLE(zf)*(vy(r,p,w,z)-vy(r,p,w,z+zif))/DBLE(zif)
         vz(r,p,w,zint)=vz(r,p,w,z)-
